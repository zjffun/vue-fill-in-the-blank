...
url=https://api.github.com/repos/zjffun/vue-fill-in-the-blank/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "vue-fill-in-the-blank更新", "text": "@所有人\n# [vue-fill-in-the-blank]('$html_url')\n'$body'"}}'
